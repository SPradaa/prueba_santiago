                        ...
                        <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link tm-nav-link" href="reporte.php">Reportes <span class="sr-only">(current)</span></a>
                                </li>                            
                                <li class="nav-item">
                    ...
                    <section class="tm-content">
                        <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                            ...
                            <div class="media-body tm-service-text">
                                <h2 class="mb-4 tm-content-title">Visualiza el reporte del parque</h2>
                                <p>Ingresa al siguiente link para visualizar las estadisticas de TECNOPARK</p>
                        ...
                        <a href="view.php" class="btn btn-primary">Continue...</a>   
        </div>      
